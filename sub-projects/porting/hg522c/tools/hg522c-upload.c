...
void usage(void)
{
	printf("hg522c-upload [fw-file] [gw-ipaddr]\n");
	printf("  [fw-file] : firmware file to be uploaded\n");
	printf("  [gw-ipaddr] : HG522-C gateway IP address\n");
}

int upload(char *fw, char *host)
{
	int rc = 0;
...
int main(int argc, char **argv)
{
	...
	fw_file = argv[1];
	host_ipaddr = argv[2];
	return upload(fw_file, host_ipaddr);
}
