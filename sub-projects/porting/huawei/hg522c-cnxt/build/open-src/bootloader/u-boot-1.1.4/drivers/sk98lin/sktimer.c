 ...
 *
 *	$Log: sktimer.c,v $
 *	Revision 1.1  2006/08/22 15:55:32  guptaa2
...
static const char SysKonnectFileId[] =
	"$Header: /cvsroot/source/open-src/bootloader/u-boot-1.1.4/drivers/sk98lin/sktimer.c,v 1.1 2006/08/22 15:55:32 guptaa2 Exp $" ;
