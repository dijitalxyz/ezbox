 ...
 *
 *	$Log: skqueue.c,v $
 *	Revision 1.1  2006/08/22 15:55:31  guptaa2
...
static const char SysKonnectFileId[] =
	"$Header: /cvsroot/source/open-src/bootloader/u-boot-1.1.4/drivers/sk98lin/skqueue.c,v 1.1 2006/08/22 15:55:31 guptaa2 Exp $" ;
