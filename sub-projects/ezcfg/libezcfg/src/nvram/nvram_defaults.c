...
ezcfg_nv_pair_t default_nvram_settings[] = {
	...
	{ NVRAM_SERVICE_OPTION(EZCFG, AUTH_0_USER), EZCFG_AUTH_DEFAULT_USER_STRING },
	/* EZCFG authentication realm */
	{ NVRAM_SERVICE_OPTION(EZCFG, AUTH_0_REALM), EZCFG_AUTH_DEFAULT_REALM_STRING },
	/* EZCFG authentication domain */
	{ NVRAM_SERVICE_OPTION(EZCFG, AUTH_0_DOMAIN), EZCFG_AUTH_DEFAULT_DOMAIN_STRING },
	/* EZCFG authentication secret */
	{ NVRAM_SERVICE_OPTION(EZCFG, AUTH_0_SECRET), EZCFG_AUTH_DEFAULT_SECRET_STRING },
