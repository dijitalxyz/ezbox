...
ezcfg_nv_pair_t default_nvram_settings[] = {
	...
	/*--------------------*/
	/* WLAN interface name */
	{ NVRAM_SERVICE_OPTION(WLAN, IFNAME), "wlan0" },
	/* Enslaved LAN interfaces */
	{ NVRAM_SERVICE_OPTION(WLAN, IFNAMES), "" },
	...
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, SCAN_SSID), "1" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, SSID), "ezbox-wlan" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, BSSID), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, KEY_MGMT), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, PROTO), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, IEEE80211W), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, PSK), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, PAIRWISE), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, GROUP), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, EAP), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, CA_CERT), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, PRIV_KEY), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, PRIV_KEY_PWD), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, PHASE2), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, IDENTITY), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, PASSWORD), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, WEP_KEY0), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, WEP_KEY1), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, WEP_KEY2), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, WEP_KEY3), "" },
	{ NVRAM_SERVICE_OPTION(WPA_SUPPLICANT, WEP_TX_KEYIDX), "" },
#endif
