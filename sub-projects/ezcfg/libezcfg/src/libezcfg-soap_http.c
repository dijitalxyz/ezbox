...
static void build_nvram_get_response(struct ezcfg_soap_http *sh, struct ezcfg_nvram *nvram, const char *name)
{
	struct ezcfg *ezcfg;
	struct ezcfg_http *http;
	struct ezcfg_soap *soap;
...
static void build_nvram_set_response(struct ezcfg_soap_http *sh, struct ezcfg_nvram *nvram, const char *name, const char *value)
{
	struct ezcfg *ezcfg;
	struct ezcfg_http *http;
	struct ezcfg_soap *soap;
...
static void build_nvram_unset_response(struct ezcfg_soap_http *sh, struct ezcfg_nvram *nvram, const char *name)
{
	struct ezcfg *ezcfg;
	struct ezcfg_http *http;
	struct ezcfg_soap *soap;
...
static void build_nvram_list_response(struct ezcfg_soap_http *sh, struct ezcfg_nvram *nvram)
{
	struct ezcfg *ezcfg;
	struct ezcfg_http *http;
	struct ezcfg_soap *soap;
...
static void build_nvram_commit_response(struct ezcfg_soap_http *sh, struct ezcfg_nvram *nvram)
{
	struct ezcfg *ezcfg;
	struct ezcfg_http *http;
	struct ezcfg_soap *soap;
...
void ezcfg_soap_http_handle_nvram_request(struct ezcfg_soap_http *sh, struct ezcfg_nvram *nvram)
{
	...
	if (strncmp(request_uri, EZCFG_SOAP_HTTP_NVRAM_GET_URI, strlen(EZCFG_SOAP_HTTP_NVRAM_GET_URI)) == 0) {
		...
		build_nvram_get_response(sh, nvram, name);
	}
